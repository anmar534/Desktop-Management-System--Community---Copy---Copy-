...
#### اليوم 1: الإعداد الأولي

**المهام:**

- [ ] **09:00-10:00** اجتماع الفريق لمراجعة الخطة
...
- [ ] **10:00-11:00** إعداد بيئة التطوير
...
- [ ] **11:00-12:00** إنشاء هيكل المجلدات الجديد
...
- [ ] **13:00-14:30** قياس Baseline الحالي
...
- [ ] **16:00-17:00** إنشاء خطة الاختبار
...
### اليوم 6 (الإثنين): حذف الملفات القديمة
...
- [ ] **10:30-11:30** حذف TenderPricingPage.LEGACY.tsx
...
- [ ] **11:30-12:00** حذف TenderPricingPage_OLD.tsx
- [ ] **12:00-13:00** استراحة الغداء

- [ ] **13:00-13:30** حذف TenderPricingPage.BEFORE_PHASE_2.5.tsx
- [ ] **13:30-14:00** حذف TenderPricingPage.tsx.backup-\*

- [ ] **14:00-15:30** التحقق الشامل
...
- [ ] **15:30-16:30** مراجعة الكود (Code Review)
- [ ] **16:30-17:00** توثيق التغييرات
