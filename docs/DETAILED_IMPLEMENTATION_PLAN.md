...
**المدة:** 3 أشهر (15 نوفمبر 2025 - 15 فبراير 2026)  
...
### Sprint 1.1: الأساس والربط مع المنافسات (أسبوع 1-2)
...
#### Tasks التفصيلية:
- [ ] **Backend**: إنشاء `ProjectService` مع ربط المنافسات
- [ ] **Backend**: تطوير `EarnedValueCalculator` للمؤشرات
- [ ] **Frontend**: تطوير `ProjectCreationWizard` component
- [ ] **Frontend**: تطوير `ProjectOverview` component
- [ ] **Testing**: Unit tests للخدمات الجديدة
...
### Sprint 1.2: تتبع التكاليف الفعلية (أسبوع 3-4)

#### Sprint Goal:
تطوير نظام تتبع التكاليف الفعلية مقابل التقديرية مع مؤشرات EVM

#### User Stories:
1. **كمدير مشاريع، أريد تسجيل التكاليف الفعلية، لكي أتتبع الإنفاق الحقيقي** (Story Points: 8)
   - تسجيل تكاليف المواد والعمالة والمعدات
   - ربط التكاليف ببنود BOQ المحددة
   - تصنيف التكاليف (مباشرة، غير مباشرة، إدارية)
   - تسجيل تواريخ الإنفاق الدقيقة

2. **كمدير مشاريع، أريد مقارنة التكاليف الفعلية بالتقديرية، لكي أتحكم في الميزانية** (Story Points: 13)
   - حساب الانحرافات (Cost Variance)
   - حساب مؤشرات الأداء (CPI, SPI)
   - عرض التحليلات البصرية للانحرافات
   - إنشاء تنبيهات عند تجاوز الحدود المسموحة

#### Tasks التفصيلية:
- [ ] **Backend**: تطوير `CostTrackingService`
- [ ] **Backend**: تطوير `VarianceAnalysisEngine`
- [ ] **Frontend**: تطوير `CostEntryForm` component
- [ ] **Frontend**: تطوير `CostVarianceChart` component
- [ ] **Testing**: Unit tests لحسابات EVM
- [ ] **Testing**: E2E tests لتدفق تسجيل التكاليف
- [ ] **Documentation**: User guide لتسجيل التكاليف

#### Definition of Done:
- ✅ تسجيل التكاليف الفعلية يعمل بدقة
...
### Sprint 1.3: الجدولة الزمنية ومخططات Gantt (أسبوع 5-6)
...
2. **كمدير مشاريع، أريد عرض مخطط Gantt تفاعلي، لكي أتابع التقدم بصرياً** (Story Points: 8)
   - عرض مخطط Gantt للمشروع
   - إمكانية تعديل المهام من المخطط
   - عرض التقدم الفعلي مقابل المخطط
   - تحديد المسار الحرج (Critical Path)

#### Tasks التفصيلية:
- [ ] **Backend**: تطوير `SchedulingService`
- [ ] **Backend**: تطوير `CriticalPathCalculator`
- [ ] **Frontend**: تكامل مكتبة Gantt (react-gantt-timeline)
- [ ] **Frontend**: تطوير `GanttChart` component
- [ ] **Testing**: Unit tests لحسابات المسار الحرج
- [ ] **Testing**: E2E tests للتفاعل مع مخطط Gantt
- [ ] **Documentation**: User guide للجدولة الزمنية

### Sprint 1.4: إدارة المهام والأنشطة (أسبوع 7-8)

#### Sprint Goal:
تطوير نظام إدارة المهام والأنشطة مع تتبع التقدم
...
2. **كعضو فريق، أريد تحديث تقدم المهام، لكي أبلغ عن الإنجاز** (Story Points: 5)
   - تحديث نسبة الإنجاز للمهام
   - إضافة تعليقات وملاحظات
   - رفع ملفات مرتبطة بالمهام
   - تسجيل الوقت المستغرق

#### Tasks التفصيلية:
- [ ] **Backend**: تطوير `TaskManagementService`
- [ ] **Backend**: تطوير `ProgressTrackingService`
- [ ] **Frontend**: تطوير `TaskBoard` component (Kanban style)
- [ ] **Frontend**: تطوير `TaskDetails` component
- [ ] **Testing**: Unit tests لإدارة المهام
- [ ] **Testing**: Integration tests لتحديث التقدم
- [ ] **Documentation**: User guide لإدارة المهام

### Sprint 1.5: تقارير تقدم المشاريع (أسبوع 9-10)
...
#### Tasks التفصيلية:
- [ ] **Backend**: تطوير `ProjectReportingService`
- [ ] **Backend**: تطوير `KPICalculationEngine`
- [ ] **Frontend**: تطوير `ProjectReports` component
- [ ] **Frontend**: تطوير `ProjectsDashboard` component
- [ ] **Testing**: Unit tests لحسابات KPIs
- [ ] **Testing**: E2E tests لتوليد التقارير
- [ ] **Documentation**: User guide للتقارير

### Sprint 1.6: التحسين والتكامل (أسبوع 11-12)
...
#### Tasks التفصيلية:
- [ ] **Backend**: تحسين أداء قاعدة البيانات
- [ ] **Frontend**: تحسين أداء المكونات
- [ ] **Testing**: اختبارات الأداء والحمولة
- [ ] **Testing**: اختبارات التكامل الشاملة
- [ ] **Documentation**: تحديث التوثيق الفني
- [ ] **Documentation**: إعداد دليل المستخدم النهائي

### المخرجات الرئيسية للمرحلة 1:
- ✅ نظام إدارة مشاريع شامل ومتطور
- ✅ ربط تلقائي مع نظام المنافسات
- ✅ تتبع دقيق للتكاليف مع مؤشرات EVM
- ✅ مخططات Gantt تفاعلية
- ✅ إدارة مهام وأنشطة متقدمة
- ✅ تقارير شاملة لتقدم المشاريع
...
- ✅ 90%+ test coverage للكود الجديد
- ✅ أداء أقل من 2 ثانية لجميع العمليات
...
#### Quality Gates:
- ✅ Code Review approval من شخصين
- ✅ جميع الاختبارات تمر بنجاح
- ✅ Performance benchmarks تُحقق
- ✅ Security scan بدون ثغرات حرجة
- ✅ Accessibility audit يمر بنجاح
...
- [ ] تطوير `FinancialStatementsService`
- [ ] تطوير `AccountingEngine` للحسابات
- [ ] تطوير `IncomeStatement` component
- [ ] تطوير `BalanceSheet` component
- [ ] حساب الإيرادات من المشاريع والمنافسات
- [ ] حساب تكلفة البضاعة المباعة
- [ ] حساب المصروفات التشغيلية
- [ ] حساب صافي الدخل والهوامش
