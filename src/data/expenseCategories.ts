...
export const EXPENSE_FREQUENCIES = {
  MONTHLY: {
    ...
    nameEn: 'Monthly',
    multiplier: 12,
    color: EXPENSE_FREQUENCY_COLOR_CLASSES.MONTHLY,
  },
  QUARTERLY: {
    id: 'quarterly',
    nameAr: 'ربع سنوية',
    nameEn: 'Quarterly',
    multiplier: 4,
    color: EXPENSE_FREQUENCY_COLOR_CLASSES.QUARTERLY,
  },
  ANNUALLY: {
    id: 'annually',
    nameAr: 'سنوية',
    nameEn: 'Annually',
    multiplier: 1,
    color: EXPENSE_FREQUENCY_COLOR_CLASSES.ANNUALLY,
  },
  SEMI_ANNUALLY: {
    id: 'semi_annually',
    nameAr: 'نصف سنوية',
    nameEn: 'Semi-Annually',
    multiplier: 2,
    color: EXPENSE_FREQUENCY_COLOR_CLASSES.SEMI_ANNUALLY,
  },
  WEEKLY: {
    id: 'weekly',
    nameAr: 'أسبوعية',
    nameEn: 'Weekly',
    multiplier: 52,
    color: EXPENSE_FREQUENCY_COLOR_CLASSES.WEEKLY,
  },
  ONE_TIME: {
    id: 'one_time',
    nameAr: 'مرة واحدة',
    nameEn: 'One Time',
    multiplier: 0,
    color: EXPENSE_FREQUENCY_COLOR_CLASSES.ONE_TIME,
  },
} as const
...
export const PAYMENT_STATUS = {
  PENDING: {
    ...
    nameAr: 'في الانتظار',
    nameEn: 'Pending',
    color: PAYMENT_STATUS_COLOR_CLASSES.PENDING,
  },
  COMPLETED: {
    id: 'completed',
    nameAr: 'مكتمل',
    nameEn: 'Completed',
    color: PAYMENT_STATUS_COLOR_CLASSES.COMPLETED,
  },
  OVERDUE: {
    id: 'overdue',
    nameAr: 'متأخر',
    nameEn: 'Overdue',
    color: PAYMENT_STATUS_COLOR_CLASSES.OVERDUE,
  },
  CANCELLED: {
    id: 'cancelled',
    nameAr: 'ملغي',
    nameEn: 'Cancelled',
    color: PAYMENT_STATUS_COLOR_CLASSES.CANCELLED,
  },
} as const
...
export const EXPENSE_CATEGORIES: ExpenseCategory[] = [
  // ======== المصروفات الإدارية ========
  {
    ...
    subcategories: [
      ...
      {
        id: 'admin_staff_salaries',
        nameAr: 'رواتب الموظفين الإداريين',
        nameEn: 'Administrative Staff Salaries',
      },
    ...
    subcategories: [
      {
        ...
        nameAr: 'التأمين الطبي الإداري',
        nameEn: 'Administrative Health Insurance',
      },
      {
        id: 'social_insurance_admin',
        nameAr: 'التأمينات الاجتماعية الإدارية',
        nameEn: 'Administrative Social Insurance',
      },
      {
        id: 'end_service_admin',
        nameAr: 'مكافآت نهاية الخدمة الإدارية',
        nameEn: 'Administrative End of Service Benefits',
      },
      {
        id: 'training_admin',
        nameAr: 'التدريب والتطوير الإداري',
        nameEn: 'Administrative Training & Development',
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      {
        id: 'warehouse_rent',
        nameAr: 'إيجار المستودعات الإدارية',
        nameEn: 'Administrative Warehouse Rent',
      },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'promotional_materials', nameAr: 'المواد الترويجية', nameEn: 'Promotional Materials' },
      {
        ...
        nameAr: 'صيانة الموقع الإلكتروني',
  ...
  },
  {
    ...
    subcategories: [
      {
        id: 'vehicle_maintenance_admin',
        nameAr: 'صيانة المركبات الإدارية',
        nameEn: 'Administrative Vehicle Maintenance',
      },
      { id: 'fuel_admin', nameAr: 'وقود المركبات الإدارية', nameEn: 'Administrative Vehicle Fuel' },
      {
        id: 'vehicle_insurance_admin',
        nameAr: 'تأمين المركبات الإدارية',
        nameEn: 'Administrative Vehicle Insurance',
      },
      {
        id: 'travel_expenses',
        nameAr: 'مصاريف السفر والانتداب',
        nameEn: 'Travel & Business Trip Expenses',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subcategories: [
      { id: 'electrical_materials', nameAr: 'المواد الكهربائية', nameEn: 'Electrical Materials' },
      {
        ...
        nameAr: 'مواد السباكة والصحي',
        nameEn: 'Plumbing & Sanitary Materials',
      },
  ...
  },
  {
    ...
    subcategories: [
      ...
      {
        id: 'specialized_contractors',
        nameAr: 'المقاولون المتخصصون',
        nameEn: 'Specialized Contractors',
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      {
        id: 'inspection_fees',
        nameAr: 'رسوم التفتيش والاعتماد',
        nameEn: 'Inspection & Approval Fees',
      },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'worker_transportation', nameAr: 'نقل العمال', nameEn: 'Worker Transportation' },
      {
        ...
        nameAr: 'تنسيق اللوجستيات',
        nameEn: 'Logistics Coordination',
      },
    ],
  },
  {
    ...
    subcategories: [
      {
        id: 'safety_equipment',
        nameAr: 'معدات السلامة المهنية',
        nameEn: 'Occupational Safety Equipment',
      },
