      ...
      <section>
        ...
        <div className="grid grid-cols-3 gap-6">
          <div className="border border-border rounded-lg p-6">
            ...
            <code className="text-xs text-muted-foreground mt-2 block">gap: {tokens.spacing[1]}</code>
          </div>
          ...
          <div className="border border-border rounded-lg p-6">
            ...
            <code className="text-xs text-muted-foreground mt-2 block">gap: {tokens.spacing[4]}</code>
          </div>
          ...
          <div className="border border-border rounded-lg p-6">
            ...
            <code className="text-xs text-muted-foreground mt-2 block">gap: {tokens.spacing[8]}</code>
          </div>
        </div>
      </section>
    </div>
