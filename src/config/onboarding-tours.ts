...
export const mainAppTour: TourStep[] = [
  ...
  },
  {
    ...
    content: 'Use the sidebar to navigate between different sections of the application. You can collapse it by clicking the menu icon.',
    contentAr: 'استخدم القائمة الجانبية للتنقل بين أقسام التطبيق المختلفة. يمكنك طيها بالنقر على أيقونة القائمة.',
    placement: 'right',
  },
  {
    id: 'search',
    ...
    content: 'Search for anything in the system using the search bar. You can also use Ctrl+K to open the command palette.',
    contentAr: 'ابحث عن أي شيء في النظام باستخدام شريط البحث. يمكنك أيضاً استخدام Ctrl+K لفتح لوحة الأوامر.',
    placement: 'bottom',
  },
  {
    id: 'notifications',
  ...
  },
  {
    ...
    content: 'You can always access this tour again from the help menu. Press ? to see keyboard shortcuts.',
    contentAr: 'يمكنك دائماً الوصول إلى هذه الجولة مرة أخرى من قائمة المساعدة. اضغط ? لرؤية اختصارات لوحة المفاتيح.',
    placement: 'bottom',
  },
]
...
export const financialTour: TourStep[] = [
  ...
  },
  {
    ...
    content: 'Generate detailed financial reports including income statements, balance sheets, and cash flow.',
    contentAr: 'إنشاء تقارير مالية مفصلة بما في ذلك بيانات الدخل والميزانيات العمومية والتدفقات النقدية.',
    placement: 'left',
  },
]
