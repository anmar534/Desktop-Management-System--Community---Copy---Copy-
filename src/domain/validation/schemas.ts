...
export class ValidationError extends Error {
  constructor(
    public readonly entity: 'project' | 'tender' | 'bankAccount',
...
export const validateProject = (project: Project): Project =>
  parseOrThrow('project', projectSchema, project)
...
export const validateTender = (tender: Tender): Tender =>
  parseOrThrow('tender', tenderSchema, tender)
