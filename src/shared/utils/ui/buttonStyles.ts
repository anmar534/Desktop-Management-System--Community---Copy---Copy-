...
export const BUTTON_STYLES = {
  ...
  delete: {
    className:
      'h-8 px-2 text-destructive transition-colors group hover:text-destructive hover:bg-destructive/10',
    variant: 'ghost' as const,
  ...
  primary: {
    className:
      'h-8 bg-primary text-primary-foreground shadow-md transition-all duration-200 group hover:bg-primary/90 hover:shadow-lg',
  ...
  success: {
    className:
      'h-8 bg-success text-success-foreground shadow-md transition-all duration-200 group hover:bg-success/90 hover:shadow-lg',
    variant: 'default' as const,
    iconClass: 'h-4 w-4 mr-1 group-hover:scale-110 transition-transform',
  },
  ...
  warning: {
    className:
      'h-8 bg-warning text-warning-foreground shadow-md transition-all duration-200 group hover:bg-warning/90 hover:shadow-lg',
    variant: 'default' as const,
    iconClass: 'h-4 w-4 mr-1 group-hover:scale-110 transition-transform',
  },
  ...
  secondary: {
    className:
      'h-8 bg-muted text-muted-foreground shadow-md transition-all duration-200 group hover:bg-muted/80 hover:shadow-lg',
    variant: 'default' as const,
    iconClass: 'h-4 w-4 mr-1 group-hover:scale-110 transition-transform',
  },
}
