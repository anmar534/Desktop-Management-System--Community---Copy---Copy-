          ...
          {Object.entries(tokens.typography.lineHeight).map(([key, value]) => (
            <div key={key} className="border border-border rounded-lg p-4">
              ...
              <p style={{ lineHeight: value }}>
                هذا نص تجريبي طويل يستخدم لعرض ارتفاع السطر. يمكنك رؤية المسافة بين الأسطر بوضوح في
                هذا المثال. This is a sample text to demonstrate line height. You can clearly see
                the spacing between lines in this example.
              </p>
            </div>
          ))}
        </div>
