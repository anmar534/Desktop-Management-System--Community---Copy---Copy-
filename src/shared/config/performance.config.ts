...
export const CODE_SPLITTING = {
  ...
  prefetchRoutes: ['/dashboard', '/tenders', '/projects', '/financial'],
} as const
...
export const LAZY_LOADING = {
  ...
  lazyComponents: ['Charts', 'Reports', 'Analytics', 'ExcelProcessor', 'PDFViewer'],
} as const
...
export const NETWORK_OPTIMIZATION = {
  ...
  dnsPrefetchDomains: ['https://api.example.com'],
 ...
 */
export function isGoodPerformance(
 ...
 */
export function isPoorPerformance(
  metric: keyof typeof PERFORMANCE_THRESHOLDS,
  value: number,
): boolean {
  const threshold = PERFORMANCE_THRESHOLDS[metric]
