...
class AnalyticsServiceImpl {
  ...
  async getAllBidPerformances(
    options?: GetAllBidPerformancesOptions,
  ...
  async getPerformanceSummary(filter?: AnalyticsFilter): Promise<PerformanceSummary> {
    ...
    const winRateTrendPoints = this.buildMonthlySeries(records, (items) => this.calculateWinRate(items))
    const marginTrendPoints = this.buildMonthlySeries(records, (items) => this.calculateAverageMargin(items))
