 ...
 *
 * تم تقسيم centralDataService (767 سطر) إلى 6 خدمات متخصصة:
 *
 * 1. TenderDataService.ts (268 سطر) - إدارة المنافسات
 * 2. ProjectDataService.ts (245 سطر) - إدارة المشاريع
 * 3. ClientDataService.ts (213 سطر) - إدارة العملاء
 * 4. RelationshipService.ts (312 سطر) - إدارة العلاقات بين الكيانات
 * 5. BOQDataService.ts (266 سطر) - إدارة جداول الكميات
 * 6. PurchaseOrderService.ts (251 سطر) - إدارة أوامر الشراء
 *
 * Total: 1,555 سطر (مقابل 767 سطر)
