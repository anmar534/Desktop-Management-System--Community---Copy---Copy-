...
export const DESCRIPTION_ALIASES = [
  'description','itemName','desc','name','title','specifications','details','itemDesc','itemDescription','label','text'
] as const
...
export function updatePricingConfig(partial: Partial<{ vatRate: number; defaultPercentages: Partial<PricingBusinessConfig['defaultPercentages']> }>) {
