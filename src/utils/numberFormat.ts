...
export function formatInteger(value: number | string | null | undefined, options?: Pick<FormatNumberOptions, 'locale'>): string {
  return formatNumber(value, { minimumFractionDigits: 0, maximumFractionDigits: 0, ...options });
}

export function formatPercent(value: number | string | null | undefined, fractionDigits = 2, options?: Pick<FormatNumberOptions, 'locale'>): string {
