...
const QualityAssurance: React.FC<QualityAssuranceProps> = React.memo(({ className }) => {
  ...
  const [consistencyVerification, setConsistencyVerification] =
    useState<ConsistencyVerificationResult | null>(null)
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-center text-gray-500 py-8">
                سيتم تطوير واجهة التحقق من التسعير قريباً
              </p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="errors">
          <Card>
            ...
            <CardContent>
              <p className="text-center text-gray-500 py-8">
                سيتم تطوير واجهة اكتشاف الأخطاء قريباً
              </p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="consistency">
          <Card>
            ...
            <CardContent>
              <p className="text-center text-gray-500 py-8">
                سيتم تطوير واجهة التحقق من التناسق قريباً
              </p>
            </CardContent>
          </Card>
        </TabsContent>
