            ...
            <div className="text-center">
              ...
              {data.length > 0 && (
                <div className="mt-2 space-y-1">
                  ...
                  {trendInfo && (
                    <p className="text-xs">
                      التغيير: {formatValue(trendInfo.change)} (
                      {formatPercentage(trendInfo.changePercentage)})
                    </p>
                  )}
                </div>
              )}
          ...
          <div className="mt-4 space-y-2">
            {data.map((item, index) => (
              ...
              >
                ...
                <div className="text-right">
                  {showValues && <p className="font-semibold">{formatLargeNumber(item.value)}</p>}
                  {showPercentages && (
...
export const PerformanceOverviewChart: React.FC<PerformanceOverviewChartProps> = React.memo(
  ({ performanceSummary, winRateTrend, marginTrend, height = 400 }) => {
