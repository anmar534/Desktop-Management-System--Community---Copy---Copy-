      ...
      return {
        ...
        efficiency:
          bidPerformances.length > 0
            ? bidPerformances.reduce((sum, p) => sum + (p.metrics?.efficiency || 0), 0) /
          ...
          <CardContent>
            ...
            {trend !== 0 && (
              <div className={`flex items-center text-xs ${trendColor}`}>
                {trendIcon}
                <span className="ml-1">{formatPercentage(Math.abs(trend))} من الشهر الماضي</span>
              </div>
            )}
          </CardContent>
        </Card>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">تحليل شامل لأداء المناقصات والذكاء التنافسي</p>
          </div>
          <div className="flex items-center space-x-2">
        ...
        <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-4">
          <TabsList>
            ...
            {showMarketIntelligence && <TabsTrigger value="market">ذكاء السوق</TabsTrigger>}
          ...
          <TabsContent value="performance" className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>تطور معدل الفوز خلال الفترة المحددة</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>تطور متوسط الهامش خلال الفترة المحددة</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="h-64 flex items-center justify-center text-muted-foreground">
                    <div className="text-center">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>تحليل الأداء موزع على فئات المشاريع المختلفة</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="competitive" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>تحليل المنافسين وموقعنا في السوق</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-64 flex items-center justify-center text-muted-foreground">
                  <div className="text-center">
          ...
          <TabsContent value="market" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>اتجاهات السوق والفرص المتاحة</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-64 flex items-center justify-center text-muted-foreground">
                  <div className="text-center">
          ...
          <TabsContent value="reports" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>تقارير مفصلة وقابلة للتخصيص</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-64 flex items-center justify-center text-muted-foreground">
                  <div className="text-center">
