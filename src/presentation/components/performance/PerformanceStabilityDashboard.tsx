    ...
    <div className={`p-6 space-y-6 ${className}`} dir="rtl">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">مراقبة وتحسين أداء النظام واستقراره</p>
        </div>
        <div className="flex items-center space-x-2 space-x-reverse">
          ...
          <TabsContent value="metrics" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>آخر {metrics.length} مقياس أداء</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="optimizations" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>قواعد التحسين المطبقة على النظام</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="errors" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>الأخطاء الحديثة والمعلقة</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="analytics" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>تحليلات مفصلة لأداء النظام</CardDescription>
              </CardHeader>
              <CardContent>
