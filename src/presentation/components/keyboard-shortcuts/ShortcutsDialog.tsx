...
import { formatShortcut } from '@/application/hooks/useKeyboardShortcuts'
  ...
  return (
    <>
      ...
      <Dialog show={open}>
            ...
            Object.entries(groupedShortcuts).map(([category, items]) => (
              <CategorySection key={category}>
                ...
                <ShortcutsList>
                  {items.map((shortcut) => {
                    const description =
                      rtl && shortcut.descriptionAr ? shortcut.descriptionAr : shortcut.description
        ...
        <Footer>
          {rtl ? 'اضغط ? لفتح هذا الحوار في أي وقت' : 'Press ? to open this dialog anytime'}
        </Footer>
      </Dialog>
    </>
  )
