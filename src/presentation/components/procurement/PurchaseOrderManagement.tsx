    ...
    <div className="space-y-6" dir="rtl">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">إدارة شاملة لأوامر الشراء والمشتريات</p>
        </div>
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="max-w-2xl" dir="rtl">
            <DialogHeader>
              ...
              <DialogDescription>أدخل تفاصيل أمر الشراء الجديد</DialogDescription>
            </DialogHeader>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({ ...prev, tenderName: e.target.value }))
                    }
            ...
            <DialogFooter>
              ...
              <Button onClick={handleCreateOrder}>إنشاء أمر الشراء</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      </div>
