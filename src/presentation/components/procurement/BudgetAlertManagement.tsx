...
const BudgetAlertManagement: React.FC<BudgetAlertManagementProps> = ({
  ...
  const getAlertTypeText = (type: BudgetAlert['type']) => {
    switch (type) {
      ...
      case 'budget_warning':
        return 'تحذير الميزانية'
      case 'variance_high':
        return 'انحراف عالي'
      case 'commitment_high':
        return 'التزامات عالية'
      default:
        return 'غير محدد'
    }
  }
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription>إدارة وتتبع تنبيهات الميزانية والانحرافات</CardDescription>
            </div>
            <div className="flex space-x-2 space-x-reverse">
              <Button
              ...
              {filteredAlerts.map((alert) => {
                ...
                return (
                  <TableRow key={alert.id}>
                    ...
                    <TableCell>{new Date(alert.createdAt).toLocaleDateString('ar-SA')}</TableCell>
                    <TableCell>
                      {alert.isActive ? (
      ...
      <Dialog open={isDetailDialogOpen} onOpenChange={setIsDetailDialogOpen}>
        <DialogContent className="max-w-md" dir="rtl">
          <DialogHeader>
            ...
            <DialogDescription>معلومات مفصلة عن التنبيه المحدد</DialogDescription>
          </DialogHeader>
          {selectedAlert && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 p-3 bg-gray-50 rounded-lg text-sm">{selectedAlert.message}</p>
              </div>
              ...
              <div>
                ...
                <p className="mt-1">{new Date(selectedAlert.createdAt).toLocaleString('ar-SA')}</p>
              </div>
