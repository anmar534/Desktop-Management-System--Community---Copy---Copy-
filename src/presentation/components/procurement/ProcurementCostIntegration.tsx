...
import { procurementCostIntegrationService } from '@/application/services/procurementCostIntegrationService'
import type {
  ProcurementCostLink,
  BudgetCategory,
...
} from '@/application/services/procurementCostIntegrationService'
              ...
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="mr-4">
                    ...
                    <p
                      className={`text-2xl font-bold ${budgetSummary.totalVariance >= 0 ? 'text-red-600' : 'text-green-600'}`}
                    >
            ...
            <Dialog open={isCreateLinkDialogOpen} onOpenChange={setIsCreateLinkDialogOpen}>
              ...
              <DialogContent className="max-w-md" dir="rtl">
                <DialogHeader>
                  ...
                  <DialogDescription>اربط أمر شراء بفئة ميزانية محددة</DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setLinkFormData((prev) => ({ ...prev, purchaseOrderId: e.target.value }))
                      }
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setLinkFormData((prev) => ({ ...prev, budgetCategoryId: value }))
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        setLinkFormData((prev) => ({ ...prev, notes: e.target.value }))
                      }
                  ...
                  <div className="flex justify-end space-x-2 space-x-reverse">
                    ...
                    <Button onClick={handleCreateLink}>إنشاء الربط</Button>
                  </div>
                </div>
              </DialogContent>
            </Dialog>
                ...
                <TableBody>
                  {procurementLinks.map((link) => {
                    const category = budgetCategories.find(
                      (cat) => cat.id === link.budgetCategoryId,
                    )
                    return (
            ...
            <Dialog open={isCreateCategoryDialogOpen} onOpenChange={setIsCreateCategoryDialogOpen}>
              ...
              <DialogContent className="max-w-md" dir="rtl">
                <DialogHeader>
                  ...
                  <DialogDescription>أنشئ فئة ميزانية جديدة للمشروع</DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                  <div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setCategoryFormData((prev) => ({ ...prev, nameEn: e.target.value }))
                      }
                  ...
                  <div className="flex justify-end space-x-2 space-x-reverse">
                    ...
                    <Button onClick={handleCreateCategory}>إنشاء الفئة</Button>
                  </div>
                </div>
              </DialogContent>
            </Dialog>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between text-sm">
                          <span>المتبقي:</span>
                          <span
                            className={`font-medium ${category.remainingAmount >= 0 ? 'text-green-600' : 'text-red-600'}`}
                          >
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="text-center">
                      ...
                      <p
                        className={`text-2xl font-bold ${varianceAnalysis.variance >= 0 ? 'text-red-600' : 'text-green-600'}`}
                      >
