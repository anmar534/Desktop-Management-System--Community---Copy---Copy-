...
export const ContractManagement: React.FC = () => {
  ...
  const handleEditContract = async () => {
    ...
    try {
      const updatedContract = await supplierManagementService.updateContract(selectedContract.id, {
        ...formData,
        updatedAt: new Date().toISOString(),
      })
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="max-w-2xl" dir="rtl">
            <DialogHeader>
              ...
              <DialogDescription>أدخل تفاصيل العقد الجديد</DialogDescription>
            </DialogHeader>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2 space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({ ...prev, qualityStandards: e.target.value }))
                  }
              ...
              <div className="col-span-2 space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({ ...prev, penaltyClause: e.target.value }))
                  }
            ...
            <DialogFooter>
              ...
              <Button onClick={handleCreateContract}>إنشاء العقد</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      </div>
        ...
        >
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">جميع العقود المسجلة</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">العقود السارية حالياً</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">العقود المنتهية الصلاحية</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">قيمة جميع العقود</p>
            </CardContent>
          </Card>
        </motion.div>
      </div>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-2xl" dir="rtl">
          <DialogHeader>
            ...
            <DialogDescription>تعديل تفاصيل العقد المحدد</DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleEditContract}>حفظ التغييرات</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
        <DialogContent className="max-w-3xl" dir="rtl">
          <DialogHeader>
            ...
            <DialogDescription>عرض تفاصيل العقد كاملة</DialogDescription>
          </DialogHeader>
          {selectedContract && (
