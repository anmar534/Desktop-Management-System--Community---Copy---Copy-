    ...
    <div className={`space-y-6 ${className}`} dir="rtl">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>تحليل اتجاهات المشتريات والتنبؤ بالأداء المستقبلي</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
              <label className="text-sm font-medium text-gray-700 mb-2 block">المؤشر</label>
        ...
        <TabsContent value="trends" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                تحليل {getPeriodLabel(selectedPeriod)} للفترة من {dateRange.startDate} إلى{' '}
                {dateRange.endDate}
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="insights" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>تحليل ذكي للاتجاهات مع توصيات للتحسين</CardDescription>
            </CardHeader>
            <CardContent>
              {insights.length === 0 ? (
                <div className="text-center py-8">
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <h4 className="font-medium text-gray-900 mb-2">{insight.message}</h4>
