...
export const SupplierEvaluation: React.FC = () => {
  ...
  const stats = useMemo((): EvaluationStats => {
    ...
    const average = evaluations.filter(
      (e) => e.overallRating >= 2.5 && e.overallRating < 3.5,
    ).length
  ...
  const calculateOverallRating = (scores: Partial<EvaluationFormData>) => {
    ...
    return (
      (qualityScore + deliveryScore + serviceScore + priceCompetitiveness + communicationScore) / 5
    )
  }
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="max-w-3xl" dir="rtl">
            <DialogHeader>
              ...
              <DialogDescription>قم بتقييم أداء المورد في المعايير المختلفة</DialogDescription>
            </DialogHeader>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2 space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({ ...prev, evaluatedBy: e.target.value }))
                    }
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      {[1, 2, 3, 4, 5].map((score) => (
                        ...
                        >
                          <Star
                            className={`h-4 w-4 ${formData.qualityScore >= score ? 'fill-current' : ''}`}
                          />
                        </Button>
                      ))}
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      {[1, 2, 3, 4, 5].map((score) => (
                        ...
                        >
                          <Star
                            className={`h-4 w-4 ${formData.deliveryScore >= score ? 'fill-current' : ''}`}
                          />
                        </Button>
                      ))}
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      {[1, 2, 3, 4, 5].map((score) => (
                        ...
                        >
                          <Star
                            className={`h-4 w-4 ${formData.serviceScore >= score ? 'fill-current' : ''}`}
                          />
                        </Button>
                      ))}
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      {[1, 2, 3, 4, 5].map((score) => (
                        ...
                        >
                          <Star
                            className={`h-4 w-4 ${formData.priceCompetitiveness >= score ? 'fill-current' : ''}`}
                          />
                        </Button>
                      ))}
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      {[1, 2, 3, 4, 5].map((score) => (
                        ...
                        >
                          <Star
                            className={`h-4 w-4 ${formData.communicationScore >= score ? 'fill-current' : ''}`}
                          />
                        </Button>
                      ))}
                    </div>
                  ...
                  <div className="p-4 bg-muted rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-2xl font-bold">
                        {formData.overallRating.toFixed(1)}/5
                      </span>
                    </div>
                    <Progress value={(formData.overallRating / 5) * 100} className="h-3" />
                    <div className="mt-2">{getRatingBadge(formData.overallRating)}</div>
                  </div>
                </div>
              </div>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleCreateEvaluation}>حفظ التقييم</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      </div>
        ...
        >
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">4.5+ نجوم</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">3.5-4.4 نجوم</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">أقل من 2.5 نجوم</p>
            </CardContent>
          </Card>
        </motion.div>
                  ...
                  filteredEvaluations.map((evaluation) => (
                    <TableRow key={evaluation.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-1">
                          <Progress
                            value={(evaluation.qualityScore / 5) * 100}
                            className="w-16 h-2"
                          />
                      ...
                      <TableCell>
                        <div className="flex items-center gap-1">
                          <Progress
                            value={(evaluation.deliveryScore / 5) * 100}
                            className="w-16 h-2"
                          />
                      ...
                      <TableCell>
                        <div className="flex items-center gap-1">
                          <Progress
                            value={(evaluation.serviceScore / 5) * 100}
                            className="w-16 h-2"
                          />
