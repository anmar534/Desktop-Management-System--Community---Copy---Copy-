    ...
    <div className="w-[400px] space-y-4 p-4 border rounded-lg">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-0.5">
          ...
          <p className="text-sm text-muted-foreground">استلام الإشعارات عبر SMS</p>
        </div>
        <Switch id="sms-notif" />
      </div>
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-0.5">
          ...
          <p className="text-sm text-muted-foreground">استلام إشعارات التطبيق</p>
        </div>
    ...
    <div className="w-[450px] space-y-4 p-4 border rounded-lg">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-0.5">
          ...
          <p className="text-sm text-muted-foreground">إرسال إشعار فوري عند نشر مناقصة جديدة</p>
        </div>
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-0.5">
          ...
          <p className="text-sm text-muted-foreground">تذكير قبل 24 ساعة من انتهاء المناقصة</p>
        </div>
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-0.5">
          ...
          <p className="text-sm text-muted-foreground">نقل المناقصات المنتهية للأرشيف تلقائياً</p>
        </div>
    ...
    <div className="w-[400px] space-y-4 p-4 border rounded-lg">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-0.5">
          ...
          <p className="text-sm text-muted-foreground">مساعدتنا على تحسين الخدمة</p>
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-muted-foreground">تفعيل/تعطيل المشروع</p>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-muted-foreground">تحديث حالة المشروع تلقائياً</p>
          </div>
      ...
      <div className="grid gap-4">
        <div className="flex items-center justify-between p-3 border rounded-lg">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">تفعيل خيارات البحث والفلترة المتقدمة</p>
          </div>
        ...
        <div className="flex items-center justify-between p-3 border rounded-lg">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">اقتراحات ذكية لتحسين العطاءات</p>
          </div>
        ...
        <div className="flex items-center justify-between p-3 border rounded-lg">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">تصدير التقارير بتنسيقات احترافية</p>
          </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-6 p-4 border rounded-lg">
          ...
          <div className="flex items-center gap-2">
            ...
            <Label htmlFor="light-disabled" className="opacity-50">
              معطل
            </Label>
          </div>
        </div>
      ...
      <div className="space-y-4 dark">
        ...
        <div className="flex gap-6 p-4 border rounded-lg bg-background">
          ...
          <div className="flex items-center gap-2">
            ...
            <Label htmlFor="dark-disabled" className="opacity-50">
              معطل
            </Label>
          </div>
        </div>
  ...
  render: () => (
    <div className="max-w-4xl space-y-6 p-6">
      <div>
        ...
        <p className="text-muted-foreground">مكون Switch للتبديل بين حالتين (مفعّل/غير مفعّل)</p>
      </div>
