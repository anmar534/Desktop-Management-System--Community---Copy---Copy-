  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        <span className="text-sm text-muted-foreground">تم تحديد {selectedRows.length} من 3</span>
      </div>
      <Table>
        <TableHeader>
          <TableRow>
            <TableHead className="w-12">
              <Checkbox checked={selectedRows.length === 3} onCheckedChange={toggleAll} />
            </TableHead>
  ...
  render: () => (
    <div className="max-w-4xl space-y-6 p-6">
      <div>
        ...
        <p className="text-muted-foreground">مكون Table لعرض البيانات في جداول منظمة</p>
      </div>
