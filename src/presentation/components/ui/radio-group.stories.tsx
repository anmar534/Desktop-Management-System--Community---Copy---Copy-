      ...
      <RadioGroup defaultValue="public">
        <div className="flex items-start gap-3 p-3 border rounded-lg hover:bg-accent/50 transition-colors">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground mt-1">متاحة لجميع المتقدمين دون قيود</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3 p-3 border rounded-lg hover:bg-accent/50 transition-colors">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground mt-1">التعاقد المباشر مع مورّد محدد</p>
          </div>
        </div>
      </RadioGroup>
    </div>
      ...
      <RadioGroup defaultValue="installments">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">دفع كامل المبلغ دفعة واحدة</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">تقسيط المبلغ على عدة دفعات</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">الدفع عند إتمام كل مرحلة</p>
          </div>
        </div>
      </RadioGroup>
    </div>
        ...
        <div className="space-y-3">
          ...
          <RadioGroup defaultValue="1">
            <div className="flex items-center gap-2">
              ...
              <Label htmlFor="selected-1" className="cursor-pointer">
                محدد
              </Label>
            </div>
            <div className="flex items-center gap-2">
              <RadioGroupItem value="2" id="selected-2" />
              <Label htmlFor="selected-2" className="cursor-pointer">
                غير محدد
              </Label>
            </div>
          </RadioGroup>
        ...
        <div className="space-y-3">
          ...
          <RadioGroup defaultValue="1" disabled>
            <div className="flex items-center gap-2">
              ...
              <Label htmlFor="disabled-1" className="cursor-pointer opacity-50">
                محدد ومعطل
              </Label>
            </div>
            <div className="flex items-center gap-2">
              <RadioGroupItem value="2" id="disabled-2" />
              <Label htmlFor="disabled-2" className="cursor-pointer opacity-50">
                معطل
              </Label>
            </div>
          </RadioGroup>
  ...
  render: () => (
    <div className="max-w-4xl space-y-6 p-6">
      <div>
        ...
        <p className="text-muted-foreground">مكون RadioGroup للاختيار الحصري من قائمة خيارات</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2 text-sm">
          <div>
            <code className="bg-muted px-2 py-1 rounded">RadioGroup</code> - المجموعة الأساسية
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">RadioGroupItem</code> - عنصر الاختيار
          </div>
        </div>
      </div>
