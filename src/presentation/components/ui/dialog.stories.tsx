      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid gap-2">
            ...
            <Textarea id="description" placeholder="وصف تفصيلي للمناقصة..." className="min-h-24" />
          </div>
        </div>
        <DialogFooter>
          <DialogClose asChild>
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>يرجى قراءة الشروط والأحكام بعناية قبل المتابعة.</DialogDescription>
        </DialogHeader>
        <div className="max-h-[400px] overflow-y-auto pr-4">
          <div className="space-y-4 text-sm">
            <h3 className="font-semibold">1. المقدمة</h3>
            <p>
              هذه الشروط والأحكام تحكم استخدامك لهذا النظام. باستخدامك للنظام، فإنك توافق على هذه
              الشروط.
            </p>

            <h3 className="font-semibold">2. حقوق الاستخدام</h3>
            <p>يُمنح المستخدم حق الوصول المحدود إلى النظام للأغراض المصرح بها فقط.</p>

            <h3 className="font-semibold">3. المسؤوليات</h3>
            <p>المستخدم مسؤول عن الحفاظ على سرية بيانات الدخول الخاصة به.</p>

            <h3 className="font-semibold">4. الخصوصية</h3>
            <p>نحن نحترم خصوصيتك ونلتزم بحماية بياناتك الشخصية وفقاً لسياسة الخصوصية.</p>
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[550px]">
        <DialogHeader>
          ...
          <DialogDescription>أدخل معلومات المشروع الأساسية للبدء</DialogDescription>
        </DialogHeader>
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
      ...
      <DialogContent className="sm:max-w-[600px]">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            ...
            <Input id="bid-amount" type="number" placeholder="0.00" step="0.01" />
          </div>
          ...
          <div className="rounded-lg border border-warning/30 bg-warning/10 p-4">
            <p className="text-sm text-warning-foreground">
              ⚠️ تنبيه: بمجرد تقديم العطاء، لن تتمكن من تعديله. يرجى مراجعة جميع المعلومات بعناية.
            </p>
          </div>
        </div>
        <DialogFooter>
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>قم بمراجعة التفاصيل قبل الاعتماد النهائي</DialogDescription>
        </DialogHeader>
        <div className="space-y-4 py-4">
          ...
          <div className="border-t pt-4">
            ...
            <Textarea id="approval-notes" placeholder="أضف ملاحظاتك..." className="mt-2 min-h-20" />
          </div>
        </div>
        <DialogFooter>
          <DialogClose asChild>
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>قم برفع المستندات المطلوبة للمناقصة</DialogDescription>
        </DialogHeader>
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
          ...
          <div className="grid gap-2">
            ...
            <div className="border-2 border-dashed rounded-lg p-8 text-center hover:bg-accent/50 transition-colors cursor-pointer">
              <p className="text-sm text-muted-foreground">انقر أو اسحب الملف هنا</p>
              <p className="text-xs text-muted-foreground mt-2">PDF, DOC, DOCX - حتى 10 ميجا</p>
            </div>
          </div>
        </div>
        <DialogFooter>
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[350px]">
        <DialogHeader>
          ...
          <DialogDescription>نافذة بحجم 350px للرسائل البسيطة</DialogDescription>
        </DialogHeader>
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[800px]">
        <DialogHeader>
          ...
          <DialogDescription>نافذة بحجم 800px للمحتوى الموسع</DialogDescription>
        </DialogHeader>
        ...
        <Dialog>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>النافذة في وضع الإضاءة</DialogDescription>
            </DialogHeader>
        ...
        <Dialog>
          ...
          <DialogContent className="bg-background">
            <DialogHeader>
              ...
              <DialogDescription>النافذة في الوضع المظلم</DialogDescription>
            </DialogHeader>
  ...
  render: () => (
    <div className="max-w-4xl space-y-6 p-6">
      <div>
        ...
        <p className="text-muted-foreground">مكون النافذة المنبثقة (Modal) للتفاعلات المهمة</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2 text-sm">
          <div>
            <code className="bg-muted px-2 py-1 rounded">Dialog</code> - المكون الأساسي
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">DialogTrigger</code> - الزر المحفز
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">DialogContent</code> - محتوى النافذة
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">DialogHeader</code> - رأس النافذة
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">DialogTitle</code> - العنوان
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">DialogDescription</code> - الوصف
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">DialogFooter</code> - تذييل النافذة
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">DialogClose</code> - زر الإغلاق
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2 text-sm">
          <div>
            <code className="bg-muted px-2 py-1 rounded">sm:max-w-[350px]</code> - صغير (رسائل
            بسيطة)
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">sm:max-w-[500px]</code> - متوسط (نماذج
            قصيرة)
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">sm:max-w-[600px]</code> - كبير (نماذج
            مفصلة)
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">sm:max-w-[800px]</code> - كبير جداً (محتوى
            موسع)
          </div>
        </div>
      </div>
      ...
      <Dialog>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>هذا مثال حي لمكون Dialog</DialogDescription>
          </DialogHeader>
