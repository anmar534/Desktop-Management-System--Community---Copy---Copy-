    ...
    <div className="max-w-4xl space-y-6 p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2 text-sm">
          <div>
            <code className="bg-muted px-2 py-1 rounded">Select</code> - المكون الأساسي
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">SelectTrigger</code> - الزر المحفز
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">SelectValue</code> - القيمة المعروضة
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">SelectContent</code> - محتوى القائمة
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">SelectItem</code> - عنصر في القائمة
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">SelectGroup</code> - مجموعة عناصر
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">SelectLabel</code> - عنوان المجموعة
          </div>
          <div>
            <code className="bg-muted px-2 py-1 rounded">SelectSeparator</code> - فاصل
          </div>
        </div>
      </div>
