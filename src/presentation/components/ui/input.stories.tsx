      ...
      <div>
        ...
        <div className="space-y-spacing-4">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-spacing-1">
              الحالة الافتراضية
            </p>
          </div>
          ...
          <div>
            <label className="text-sm font-medium mb-spacing-1 block text-destructive">
              خطأ
            </label>
            <Input 
              placeholder="البريد الإلكتروني"
              aria-invalid={true}
            />
            <p className="text-xs text-destructive mt-spacing-1">
      ...
      <div>
        ...
        <div className="space-y-spacing-4">
          ...
          <div className="border-l-4 border-destructive pl-spacing-4">
            ...
            <p className="text-sm text-muted-foreground">
              استخدم aria-invalid وأضف رسالة توضيحية
            </p>
            <div className="mt-spacing-2">
