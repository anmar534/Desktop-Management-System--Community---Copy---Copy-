...
export const WithError: Story = {
  render: () => (
    <div className="space-y-2">
      ...
      <p className="text-sm text-destructive mr-6">يجب الموافقة على الشروط</p>
    </div>
  ),
}
...
export const TermsAndConditions: Story = {
  render: () => (
    <div className="w-[500px] space-y-4 p-6 border rounded-lg">
      ...
      <div className="pt-2">
        <p className="text-sm text-destructive">* يجب الموافقة على جميع الشروط الإجبارية</p>
      </div>
    </div>
  ),
}
  ...
  render: () => (
    <div className="max-w-4xl space-y-6 p-6">
      <div>
        ...
        <p className="text-muted-foreground">مكون Checkbox للاختيارات المتعددة والموافقات</p>
      </div>
