                                    ...
                                    >
                                      <div className="flex items-center gap-3">
                                        ...
                                        <div className="text-sm font-semibold text-info">
                                          المواد والخامات ({item.materials.length} صنف)
                                        </div>
                                        <Badge
                                          variant="outline"
                                              ...
                                              >
                                                <td className="p-2 text-right">
                                                  <div className="font-medium text-foreground">
                                                    {m.name || m.description || 'مادة غير محددة'}
                                                  </div>
                                                  {m.specifications && (
                                                    <div className="text-xs text-muted-foreground mt-1">
                                                      {m.specifications}
                                    ...
                                    >
                                      <div className="flex items-center gap-3">
                                        ...
                                        <div className="text-sm font-semibold text-success">
                                          العمالة والأيدي العاملة ({item.labor.length} نوع)
                                        </div>
                                        <Badge
                                          variant="outline"
                                          ...
                                          <tbody>
                                            {item.labor.map((l: any, lIndex: number) => (
                                              ...
                                              >
                                                <td className="p-2 text-right">
                                                  <div className="font-medium text-foreground">
                                                    {l.description || l.type || 'عمالة غير محددة'}
                                                  </div>
                                                  {l.skill && (
                                                    <div className="text-xs text-muted-foreground mt-1">
                                                      المهارة: {l.skill}
                                    ...
                                    >
                                      <div className="flex items-center gap-3">
                                        ...
                                        <div className="text-sm font-semibold text-warning">
                                          المعدات والآلات ({item.equipment.length} معدة)
                                        </div>
                                        <Badge
                                          variant="outline"
                                          ...
                                          <tbody>
                                            {item.equipment.map((e: any, eIndex: number) => (
                                              ...
                                              >
                                                <td className="p-2 text-right">
                                                  <div className="font-medium text-foreground">
                                                    {e.description || e.name || 'معدة غير محددة'}
                                                  </div>
                                                  {e.model && (
                                                    <div className="text-xs text-muted-foreground mt-1">
                                                      الطراز: {e.model}
                                    ...
                                    >
                                      <div className="flex items-center gap-3">
                                        ...
                                        <div className="text-sm font-semibold text-accent">
                                          مقاولو الباطن والمتخصصون ({item.subcontractors.length}{' '}
                                          مقاول)
                                        </div>
                                        <Badge
                                          variant="outline"
