...
const ToastContainer = styled.div<{ type: ToastType; rtl: boolean }>`
  ...
  animation: ${(props) => (props.rtl ? slideInRTL : slideIn)}
    ${designTokens.transitions.duration.normal} ${designTokens.transitions.timing.easeOut};

  &.closing {
    animation: ${(props) => (props.rtl ? slideOutRTL : slideOut)}
      ${designTokens.transitions.duration.fast} ${designTokens.transitions.timing.easeIn};
  }
