...
const CommandItemContainer = styled.button<{ selected: boolean }>`
  ...
  background-color: ${(props) =>
    props.selected ? designTokens.colors.primary[50] : 'transparent'};
  ...
  &:hover {
    background-color: ${(props) =>
      props.selected ? designTokens.colors.primary[100] : designTokens.colors.neutral[100]};
  }
...
const CommandIcon = styled.div<{ selected: boolean }>`
  ...
  background-color: ${(props) =>
    props.selected ? designTokens.colors.primary[100] : designTokens.colors.neutral[100]};
  color: ${(props) =>
    props.selected ? designTokens.colors.primary[600] : designTokens.colors.text.secondary};
  flex-shrink: 0;
`
              ...
              <div key={category}>
                ...
                {items.map((cmd, index) => {
                  ...
                  return (
                    ...
                    >
                      <CommandIcon selected={globalIndex === selectedIndex}>{cmd.icon}</CommandIcon>
                      <CommandContent>
