          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p
                  className={`text-2xl font-bold ${daysRemaining < 0 ? 'text-red-600' : daysRemaining < 30 ? 'text-yellow-600' : 'text-green-600'}`}
                >
                  {Math.abs(daysRemaining)}
                </p>
                <p className="text-xs text-gray-500">{daysRemaining < 0 ? 'متأخر' : 'يوم متبقي'}</p>
              </div>
