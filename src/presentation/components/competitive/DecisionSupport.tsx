  ...
  ({
    ...
    const handleAnalyzeScenario = useCallback(
      async (scenarioId: string) => {
        ...
        try {
          setLoading(true)
          const analysis = await decisionSupportService.analyzeScenario(
            scenarioId,
    ...
    const getRecommendationText = (recommendation: string) => {
      switch (recommendation) {
        case 'bid':
          return 'مناقصة / Bid'
        case 'no_bid':
          return 'عدم مناقصة / No Bid'
        case 'conditional_bid':
          return 'مناقصة مشروطة / Conditional Bid'
        default:
    ...
    return (
      <div className={`space-y-6 ${className}`} dir="rtl">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">نظام دعم القرار</h2>
            <p className="text-gray-600 mt-1">
              إطار عمل شامل لاتخاذ قرارات المناقصات والتخطيط للسيناريوهات
            </p>
          </div>
          <div className="flex items-center gap-2">
            <Button onClick={() => setActiveTab('frameworks')} variant="outline" size="sm">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="scenarios" className="space-y-6">
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <CardDescription className="mt-1">{scenario.projectName}</CardDescription>
                      </div>
                      <Badge
                        variant="outline"
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {scenario.analysisResults.overallScore}/100
                        </span>
                      </div>
            ...
            {filteredScenarios.length === 0 && (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">لا توجد سيناريوهات</h3>
          ...
          <TabsContent value="analysis" className="space-y-6">
            {analysisResult ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">لا توجد نتائج تحليل</h3>
                <p className="text-gray-600">اختر سيناريو وقم بتحليله لعرض النتائج هنا</p>
              </div>
            )}
          </TabsContent>
          ...
          <TabsContent value="recommendations" className="space-y-6">
            {recommendations.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">قم بتحليل سيناريو للحصول على توصيات مخصصة</p>
              </div>
            )}
          </TabsContent>
          ...
          <TabsContent value="frameworks" className="space-y-6">
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">إدارة أطر العمل</h3>
              <p className="text-gray-600">قريباً - إدارة وتخصيص أطر عمل اتخاذ القرار</p>
            </div>
          </TabsContent>
        </Tabs>
      </div>
