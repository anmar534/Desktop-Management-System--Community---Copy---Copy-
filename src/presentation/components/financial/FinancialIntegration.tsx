...
import type {
  IntegrationSettings,
  SyncResult,
} from '@/application/services/financialIntegrationService'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">التزامن التلقائي مفعل</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {syncLog.length > 0
                    ? formatDate(syncLog[0].timestamp).split(' ')[0]
                    : 'لم يتم التزامن بعد'}
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">إجمالي السجلات المعالجة</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-green-600">
                  {syncLog.length > 0
                    ? Math.round(
                        (syncLog.filter((log) => log.success).length / syncLog.length) * 100,
                      )
                    : 0}
                  %
                </div>
                <p className="text-xs text-muted-foreground">من عمليات التزامن</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>حالة التكامل مع نظام إدارة المشاريع</CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>حالة التكامل مع نظام إدارة المنافسات</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <span>الحالة</span>
        ...
        <TabsContent value="sync" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>إدارة عمليات تزامن البيانات المالية</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {syncing && (
                <Alert>
                  <RefreshCw className="h-4 w-4 animate-spin" />
                  <AlertDescription>جاري تزامن البيانات المالية...</AlertDescription>
                </Alert>
              )}
                  ...
                  {syncLog.slice(0, 3).map((log, index) => (
                    <Card key={index}>
                      <CardContent className="pt-4">
                        ...
                        {log.errors.length > 0 && (
                          <div className="mt-2">
                            <span className="text-sm text-red-600">أخطاء: {log.errors.length}</span>
                          </div>
                        )}
                      </CardContent>
                    </Card>
          ...
          {settings && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>تخصيص إعدادات التكامل والتزامن</CardDescription>
              </CardHeader>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">عرض تنبيهات داخل النظام</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">عرض التنبيهات الحرجة فقط</p>
                    </div>
                    <Switch
        ...
        <TabsContent value="logs" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>تاريخ جميع عمليات التزامن والتكامل</CardDescription>
            </CardHeader>
            <CardContent>
              {syncLog.length === 0 ? (
