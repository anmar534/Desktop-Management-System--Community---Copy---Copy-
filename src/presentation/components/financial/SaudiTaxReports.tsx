...
import type {
  ...
  ZakatCalculation,
  TaxSettings,
} from '@/application/services/saudiTaxService'
    ...
    <div className="space-y-6" dir="rtl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-orange-600">{quickStats.pendingReturns}</div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{quickStats.lastReturnPeriod}</div>
          </CardContent>
        </Card>
      </div>
                    ...
                    >
                      ...
                      <div className="text-left">
                        <div className="font-medium">
                          {vatReturn.netVAT >= 0 ? '+' : ''}
                          {vatReturn.netVAT.toLocaleString('ar-SA')} ريال
                        </div>
            ...
            <CardContent>
              <div className="flex gap-4 items-end">
                ...
                <div className="flex-1">
                  ...
                  <Select
                    value={newReturnType}
                    onValueChange={(value: 'monthly' | 'quarterly') => setNewReturnType(value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                  ...
                  <div key={vatReturn.id} className="border rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      <div>
                        ...
                        <div className="font-medium">
                          {vatReturn.totalSales.toLocaleString('ar-SA')} ريال
                        </div>
                      </div>
                      <div>
                        <div className="text-muted-foreground">ضريبة المخرجات</div>
                        <div className="font-medium">
                          {vatReturn.outputVAT.toLocaleString('ar-SA')} ريال
                        </div>
                      </div>
                      <div>
                        <div className="text-muted-foreground">ضريبة المدخلات</div>
                        <div className="font-medium">
                          {vatReturn.inputVAT.toLocaleString('ar-SA')} ريال
                        </div>
                      </div>
                      <div>
                        <div className="text-muted-foreground">صافي الضريبة</div>
                        <div
                          className={`font-medium ${vatReturn.netVAT >= 0 ? 'text-red-600' : 'text-green-600'}`}
                        >
                          {vatReturn.netVAT >= 0 ? '+' : ''}
                          {vatReturn.netVAT.toLocaleString('ar-SA')} ريال
                        </div>
