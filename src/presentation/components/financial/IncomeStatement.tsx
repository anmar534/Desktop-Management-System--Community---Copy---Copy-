    ...
    const metrics: FinancialMetric[] = [
      {
        ...
        trend: previousStatement 
          ? (currentStatement.revenue.totalRevenue > previousStatement.revenue.totalRevenue ? 'up' : 'down')
          : 'stable',
        isGood: true
      },
      {
        ...
        trend: previousStatement 
          ? (currentStatement.grossProfit > previousStatement.grossProfit ? 'up' : 'down')
          : 'stable',
      ...
      },
      {
        ...
        trend: previousStatement 
          ? (currentStatement.operatingIncome > previousStatement.operatingIncome ? 'up' : 'down')
          : 'stable',
      ...
      },
      {
        ...
        trend: previousStatement 
          ? (currentStatement.netIncome > previousStatement.netIncome ? 'up' : 'down')
          : 'stable',
      ...
      <Card className="border-dashed">
        <CardContent className="flex flex-col items-center justify-center py-12">
          ...
          <p className="text-gray-500 text-center mb-4">
            لم يتم إنشاء قائمة دخل لهذه الفترة بعد
          </p>
          <Button onClick={() => {/* TODO: إضافة وظيفة إنشاء قائمة دخل جديدة */}}>
