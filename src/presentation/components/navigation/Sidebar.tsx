...
const MenuItemLink = styled(Link)<{ active: boolean; disabled: boolean; collapsed: boolean }>`
  ...
  color: ${(props) =>
    props.active ? designTokens.colors.primary[500] : designTokens.colors.text.secondary};
  ...
  &:hover:not([disabled]) {
    background-color: ${(props) =>
      props.active ? designTokens.colors.primary[100] : designTokens.colors.neutral[100]};
    color: ${(props) =>
      props.active ? designTokens.colors.primary[600] : designTokens.colors.text.primary};
  }
