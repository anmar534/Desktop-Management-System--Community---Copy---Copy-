                      ...
                      return (
                        <div
                          className={cn(
                            ...
                            URGENCY_INDICATOR_STYLES[urgencyStatus],
                          )}
                        >
      ...
      >
        <Card className="bg-card border-border shadow-sm hover:shadow-md transition-shadow duration-300 h-full">
          <CardHeader className="pb-3">
            ...
            <p className="text-sm text-muted-foreground">مقارنة أداء هذا الشهر مع الشهر الماضي</p>
          </CardHeader>

          <CardContent className="space-y-4">
            <InlineAlert
              variant={improvement.winRate >= 0 ? 'success' : 'warning'}
              title={improvement.winRate >= 0 ? 'معدل الفوز يتحسن' : 'معدل الفوز يحتاج متابعة'}
              description={
