  ...
  return (
    <div className="space-y-6">
                  ...
                  <div className="mt-4 rounded-lg border border-warning/30 bg-warning/10 p-3">
                    <div className="flex items-center gap-2 text-warning">
                      ...
                      <span className="text-sm">
                        لا توجد مصروفات مسجلة لهذا المشروع. قم بإضافة المشتريات والتكاليف لحساب
                        الربحية الفعلية.
                      </span>
                    </div>
                  </div>
      ...
      <Card className="border border-info/30 bg-info/10">
        <CardContent className="p-4">
          <h3 className="mb-2 font-semibold text-info">📊 كيفية عمل ربط التكاليف</h3>
          <ul className="space-y-1 text-sm text-info">
            <li>
              • يتم ربط كل مصروف بمشروع محدد من خلال <code>projectId</code>
            </li>
