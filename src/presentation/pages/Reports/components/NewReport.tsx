...
import { FileBarChart, ArrowRight, Save, Play } from 'lucide-react'
...
export function NewReport({ onSectionChange }: NewReportProps) {
  ...
  const reportTypeLabel =
    reportTypes.find((type) => type.value === formData.type)?.label ?? NOT_SET_LABEL
  const frequencyLabel =
    frequencies.find((freq) => freq.value === formData.frequency)?.label ?? 'مرة واحدة'
                      ...
                      >
                        <Checkbox
                          ...
                          onCheckedChange={(checked: boolean) =>
                            updateDataSource(source.id, checked)
                          }
                        />
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-2 rtl:space-x-reverse">
                    <Checkbox
                      ...
                      onCheckedChange={(checked: boolean) =>
                        setFormData((prev) => ({ ...prev, autoGenerate: checked }))
                      }
                    />
              ...
              <CardContent>
                <div className="bg-muted/30 p-4 rounded-lg space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{reportTypeLabel}</span>
                  </div>
                  <div className="flex justify-between">
