...
export function Invoices({ onSectionChange }: InvoicesProps) {
  ...
  return (
    ...
    >
      ...
      {/* قائمة الفواتير */}
      {isLoading ? (
        <div className="py-12 text-center text-muted-foreground">جاري تحميل بيانات الفواتير...</div>
      ) : (
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                          <div>
                            ...
                            <span className="font-medium">
                              {formatDateValue(invoice.issueDate, { locale: 'ar-EG' })}
                            </span>
                          </div>
                          <div>
                            <span className="text-muted-foreground block">تاريخ الاستحقاق</span>
                            <span className="font-medium">
                              {formatDateValue(invoice.dueDate, { locale: 'ar-EG' })}
                            </span>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <span
                              className={`font-medium ${invoice.status !== 'paid' ? 'text-warning' : 'text-success'}`}
                            >
                              {invoice.status === 'paid'
                                ? 'مدفوع بالكامل'
                                : formatCurrency(invoice.total)}
                      ...
                      <div className="lg:w-64">
                        ...
                        <div className="flex flex-wrap gap-2">
                          <EntityActions
                            ...
                            onDelete={() =>
                              setDeleteTarget({ id: invoice.id, label: invoice.invoiceNumber })
                            }
                            showPrimary={false}
                          />
