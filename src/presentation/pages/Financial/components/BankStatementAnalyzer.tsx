  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-foreground">تحليل كشف الحساب البنكي</h2>
          <p className="text-muted-foreground">
            {analysis.totalTransactions} معاملة من {analysis.dateRange.startDate} إلى{' '}
              ...
              <div className="flex items-center justify-between">
                ...
                <div
                  className={`p-3 rounded-lg ${
                    analysis.netFlow >= 0 ? 'bg-success/10' : 'bg-destructive/10'
                  }`}
                >
                  <DollarSign
                    className={`h-6 w-6 ${
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-info">{analysis.totalTransactions}</p>
                </div>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between font-bold">
                        ...
                        <span
                          className={project.netFlow >= 0 ? 'text-success' : 'text-destructive'}
                        >
                          {formatCurrency(project.netFlow)}
                        </span>
                      </div>
