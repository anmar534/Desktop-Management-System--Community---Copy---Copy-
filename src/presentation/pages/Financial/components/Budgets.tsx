...
export function Budgets({ onSectionChange }: BudgetsProps) {
  ...
  const budgetsData = useMemo(() => {
    ...
    const totalRemaining = budgets.reduce(
      (sum, budget) => sum + (budget.totalAmount - budget.spentAmount),
      0,
    )
                      ...
                      <div className="flex flex-col lg:flex-row gap-6">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            ...
                            <div
                              className={`p-3 rounded-lg ${remainingAmount >= 0 ? 'bg-success/10' : 'bg-destructive/10'}`}
                            >
                              <div className="text-sm text-muted-foreground">المتبقي</div>
                              <div
                                className={`text-lg font-semibold ${remainingAmount >= 0 ? 'text-success' : 'text-destructive'}`}
                              >
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                            <div>
                              ...
                              <span className="font-medium">
                                {formatDateValue(budget.startDate, {
                                  locale: 'ar-SA',
                                  year: 'numeric',
                                  month: 'long',
                                  day: 'numeric',
                            ...
                            <div>
                              ...
                              <span className="font-medium">
                                {formatDateValue(budget.endDate, {
                                  locale: 'ar-SA',
                                  year: 'numeric',
                                  month: 'long',
                                  day: 'numeric',
