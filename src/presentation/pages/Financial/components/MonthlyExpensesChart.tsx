  ...
  const currentMonthBreakdown: ExpenseBreakdown[] = [
    {
      name: 'المواد',
      value: 1.5,
      color: getDesignTokenExpression('chart1'),
    ...
    },
    {
      name: 'العمالة',
      value: 1.1,
      color: getDesignTokenExpression('chart2'),
    ...
    },
    {
      name: 'المعدات',
      value: 0.5,
      color: getDesignTokenExpression('chart3'),
    ...
    },
    {
      name: 'أخرى',
      value: 0.3,
      color: getDesignTokenExpression('chart4'),
  ...
  const CustomTooltip = ({ active, payload, label }: ChartTooltipProps) => {
    ...
    return (
      <div className="rounded-lg border border-border bg-card p-2 shadow-lg">
        ...
        <p className="text-sm text-primary">{`المصاريف: ${formatCurrency(payload[0].value)}`}</p>
      </div>
    )
  }
      ...
      <CardContent className="p-3 space-y-3">
        ...
        <div className="rounded-lg border border-border bg-accent/10 p-2">
          <div className="flex justify-between items-center">
            ...
            <span className="text-sm font-bold text-accent">{formatCurrency(averageMonthly)}</span>
          </div>
        </div>
