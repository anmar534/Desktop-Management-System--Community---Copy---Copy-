  ...
  render: (args) => (
    <Accordion {...args} className="w-[500px]">
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          نظام إدارة المناقصات هو منصة شاملة لإدارة عمليات المناقصات والمشتريات
          الحكومية والخاصة، من مرحلة الإعلان حتى الترسية والتنفيذ.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-2">
        <AccordionTrigger>كيف يمكنني إنشاء مناقصة جديدة؟</AccordionTrigger>
        <AccordionContent>
          يمكنك إنشاء مناقصة جديدة من خلال الضغط على زر &quot;إضافة مناقصة&quot; في لوحة
          التحكم، ثم ملء البيانات المطلوبة مثل العنوان والميزانية وجدول الكميات.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-3">
        <AccordionTrigger>ما هي المستندات المطلوبة؟</AccordionTrigger>
        <AccordionContent>
          المستندات المطلوبة تشمل: المواصفات الفنية، الشروط والأحكام، جدول
          الكميات، ورخصة العمل أو السجل التجاري للشركات المتقدمة.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
  ),
  ...
  render: (args) => (
    <Accordion {...args} className="w-[500px]">
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          محتوى القسم الأول. يمكن فتح قسم واحد فقط في كل مرة.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-2">
  ...
  render: (args) => (
    <Accordion {...args} className="w-[500px]">
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          محتوى القسم الأول. يمكن فتح عدة أقسام في نفس الوقت.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-2">
        <AccordionTrigger>القسم الثاني</AccordionTrigger>
        <AccordionContent>
          محتوى القسم الثاني. جميع الأقسام مستقلة عن بعضها.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-3">
        <AccordionTrigger>القسم الثالث</AccordionTrigger>
        <AccordionContent>
          محتوى القسم الثالث. افتح أي عدد من الأقسام.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
  ),
  ...
  render: (args) => (
    <Accordion {...args} className="w-[500px]">
      ...
      <AccordionItem value="item-2">
        ...
        <AccordionContent>
          هذا القسم مغلق ويمكن فتحه بالنقر على العنوان.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
  ),
  ...
  render: (args) => (
    <Accordion {...args} className="w-[600px]">
      ...
      <AccordionItem value="item-2">
        ...
        <AccordionContent>
          المناقصات التي انتهى موعد التقديم عليها أو تم ترسيتها.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-3">
        <AccordionTrigger>
        ...
        <AccordionContent>
          المناقصات التي تم تأجيل موعدها أو تعليقها مؤقتاً.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
  ),
    ...
    <div className="w-[700px] space-y-4">
      ...
      <Accordion type="single" collapsible>
        ...
        <AccordionItem value="faq-2">
          <AccordionTrigger>
            ما هي رسوم التقديم على المناقصات؟
          </AccordionTrigger>
          <AccordionContent>
            <div className="space-y-2">
        ...
        <AccordionItem value="faq-3">
          <AccordionTrigger>
            كيف أعرف إذا تم قبول عرضي؟
          </AccordionTrigger>
          <AccordionContent>
            <p>
              سيتم إشعارك عبر البريد الإلكتروني والرسائل النصية فور البت في
              العرض. كما يمكنك متابعة حالة عروضك من خلال لوحة التحكم في قسم
              &quot;عروضي&quot;.
            </p>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="faq-4">
          <AccordionTrigger>
            هل يمكنني تعديل العرض بعد التقديم؟
          </AccordionTrigger>
          <AccordionContent>
            <p>
              لا يمكن تعديل العرض بعد التقديم إلا في حالات استثنائية وقبل موعد
              إغلاق المناقصة بـ 48 ساعة على الأقل. يجب التواصل مع الدعم الفني
              لطلب التعديل.
            </p>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="faq-5">
          <AccordionTrigger>
            ما هي مدة صلاحية العروض؟
          </AccordionTrigger>
          <AccordionContent>
            <p>
              صلاحية العروض عادة 90 يوماً من تاريخ إغلاق المناقصة، ما لم ينص
              على خلاف ذلك في شروط المناقصة. يمكن للجهة المعنية طلب تمديد
              صلاحية العرض إذا لزم الأمر.
            </p>
          </AccordionContent>
        </AccordionItem>
      </Accordion>
        ...
        <AccordionItem value="description">
          ...
          <AccordionContent>
            <div className="space-y-2 text-sm">
              <p>
                يهدف المشروع إلى تطوير وتحديث البنية التحتية التقنية للجهة،
                ويشمل توريد وتركيب وتشغيل الأنظمة التالية:
              </p>
              <ul className="list-disc list-inside space-y-1 mr-4">
  ...
  render: () => (
    <div className="w-[700px] space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          تعلم كيفية استخدام نظام إدارة المناقصات
        </p>
      </div>
      <Accordion type="single" collapsible>
        ...
        <AccordionItem value="search">
          ...
          <AccordionContent>
            <p className="text-sm">
              يمكنك البحث عن المناقصات باستخدام الفلاتر التالية: النوع،
              الميزانية، تاريخ الإغلاق، والحالة. استخدم البحث المتقدم للعثور على
              المناقصات المناسبة لشركتك.
            </p>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="track">
          ...
          <AccordionContent>
            <p className="text-sm">
              من لوحة التحكم، يمكنك متابعة حالة جميع عروضك. ستظهر لك الحالة
              الحالية (قيد المراجعة، مقبول، مرفوض، يتطلب توضيح) مع إمكانية
      ...
      <div className="space-y-4">
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            <AccordionTrigger>القسم الأول</AccordionTrigger>
            <AccordionContent>
              محتوى القسم الأول في الوضع الفاتح
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            <AccordionTrigger>القسم الثاني</AccordionTrigger>
            <AccordionContent>
              محتوى القسم الثاني في الوضع الفاتح
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
      ...
      <div className="space-y-4 dark">
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            <AccordionTrigger>القسم الأول</AccordionTrigger>
            <AccordionContent>
              محتوى القسم الأول في الوضع الداكن
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            <AccordionTrigger>القسم الثاني</AccordionTrigger>
            <AccordionContent>
              محتوى القسم الثاني في الوضع الداكن
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
    ...
    <div className="max-w-4xl space-y-6 p-6">
      <div>
        ...
        <p className="text-muted-foreground">
          مكون Accordion لعرض المحتوى القابل للطي والتوسيع
        </p>
      </div>
      ...
      <div className="pt-4">
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="demo-1">
            ...
            <AccordionContent>
              الإجابة على السؤال الأول. انقر على العنوان للإغلاق.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="demo-2">
            <AccordionTrigger>السؤال الثاني</AccordionTrigger>
            <AccordionContent>
              الإجابة على السؤال الثاني. جرب فتح هذا القسم.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
