  ...
  render: () => (
    <div className="flex flex-col gap-spacing-6">
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-spacing-3">
          <Button><Download className="h-4 w-4" />تنزيل</Button>
          <Button variant="destructive"><Trash2 className="h-4 w-4" />حذف</Button>
          <Button variant="outline"><Save className="h-4 w-4" />حفظ</Button>
          <Button variant="secondary"><Plus className="h-4 w-4" />إضافة</Button>
          <Button variant="ghost"><RefreshCw className="h-4 w-4" />تحديث</Button>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="space-y-spacing-4">
          ...
          <div className="border-l-4 border-info pl-spacing-4">
            ...
            <Button variant="link" className="mt-spacing-2">اقرأ المزيد</Button>
          </div>
        </div>
      </div>
