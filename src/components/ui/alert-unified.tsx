  ...
  'relative w-full rounded-lg border p-4 [&>svg~*]:pr-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:right-4 [&>svg]:top-4 [&>svg]:text-foreground',
  {
    variants: {
      variant: {
        ...
        overdue: 'bg-status-overdue/10 text-status-overdue border-status-overdue/30 [&>svg]:text-status-overdue',
        dueSoon: 'bg-status-due-soon/10 text-foreground border-status-due-soon/30 [&>svg]:text-status-due-soon',
        onTrack: 'bg-status-on-track/10 text-status-on-track border-status-on-track/30 [&>svg]:text-status-on-track',
      },
      size: {
        default: 'p-4',
        sm: 'p-3 text-sm',
