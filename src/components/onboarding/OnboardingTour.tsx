...
const ProgressDot = styled.div<{ active: boolean }>`
  ...
  background-color: ${props => props.active ? designTokens.colors.primary[500] : designTokens.colors.neutral[300]};
  transition: ${designTokens.transitions.fast};
`
...
const Button = styled.button<{ variant?: 'primary' | 'secondary' }>`
  ...
  border: none;
  background-color: ${props => props.variant === 'primary' ? designTokens.colors.primary[500] : 'transparent'};
  color: ${props => props.variant === 'primary' ? designTokens.colors.neutral[0] : designTokens.colors.text.secondary};
  font-size: ${designTokens.typography.fontSize.sm};
  ...
  &:hover {
    background-color: ${props => props.variant === 'primary' ? designTokens.colors.primary[600] : designTokens.colors.neutral[100]};
  }
