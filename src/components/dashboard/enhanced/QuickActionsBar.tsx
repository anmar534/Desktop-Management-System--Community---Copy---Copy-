...
export interface QuickAction {
  ...
  /** دالة تنفيذ الإجراء */
  onClick: () => void;
  /** شارة التنبيه (عدد المهام المعلقة) */
  badge?: number;
  /** لون مخصص للإجراء */
  color?: string;
...
export interface QuickActionsBarProps {
  /** قائمة الإجراءات */
  actions: QuickAction[];
  /** الحد الأقصى للإجراءات المعروضة */
  maxVisible?: number;
  /** تخطيط الشريط */
...
// الإجراءات الافتراضية لشركات المقاولات
...
export const QuickActionsBar: React.FC<QuickActionsBarProps> = ({
  ...
  React.useEffect(() => {
    ...
    const handleKeyDown = (event: KeyboardEvent) => {
      const action = actions.find(a => a.shortcut && 
  ...
  const groupedActions = React.useMemo(() => {
    ...
    return visibleActions.reduce((groups, action) => {
