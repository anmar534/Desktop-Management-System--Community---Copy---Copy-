...
export function NewInvoice({ onSectionChange }: NewInvoiceProps) {
  ...
  const updateItem = <Field extends keyof InvoiceItem>(id: number, field: Field, value: InvoiceItem[Field]) => {
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <Select value={formData.paymentTerms} onValueChange={(value: string) => setFormData(prev => ({ ...prev, paymentTerms: value }))}>
                  <SelectTrigger>
